  ...
  methods: {
    ...
    updateFiles() {
      ...
      const deleteFile = async function (id) {
        let response = await fetch(`http://localhost:8000/api/files/${id}/`, {
          method: 'DELETE',
          headers: headers
        })
    ...
    updateTags() {
      ...
      const updateExistingTags = async function (tagName, itemID) {
        ...
        let response = await fetch(`http://localhost:8000/api/tags/${updTagObj.id}/`, {
          method: 'PATCH',
          headers: {
    ...
    updatePreviews() {
      ...
      const deletePreview = async function (itemID) {
        let response = await fetch(`http://localhost:8000/api/previews/${itemID}/`, {
          method: 'DELETE',
          headers: headers,
        })
            .catch(error => console.error(error))
    ...
    updateCatalogItem(event) {
      ...
      fetch(`http://localhost:8000/api/catalog/${this.item.id}/`, {
        method: 'PATCH',
        headers: headers,
        body: formData,
        redirect: 'follow'
